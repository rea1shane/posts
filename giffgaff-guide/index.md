...
编辑短信内容 `number` 到 `43430` 或者 `2020`，稍等片刻后，会收到包含手机号码的短信。此方法也可用于验证短信功能是否正常。
...
可能是当地运营商对境内漫游手机号码做了一定的限制。可以尝试修改手机设置 > 移动网络 > 选中你的 giffgaff 卡 > 运营商，把自动选择关闭，改为中国移动，重启设备之后应该就能收到了。
